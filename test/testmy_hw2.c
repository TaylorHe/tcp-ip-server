...
int main(int argc, char* argv[])
{
    ...
    /*
     ...
     my_atoi
     */
    my_num_base(0, "DFSS"); /* prints F*/
    my_str("\n");
    my_num_base(9, "RTFM"); /* prints FT*/
    my_str("\n");
    my_num_base(4, ""); /* prints ____*/
    my_str("\n");
    my_num_base(-2, "I");
    my_str("\n");
    ...
    i = my_strindex("a", 'a');
    printf("%i\n",i);
    i = my_strindex("fdsa", 'a');
    printf("%i\n",i);
    i = my_strindex("b", 'a');
    printf("%i\n",i);
    i = my_strindex("fadsa", 'a');
    printf("%i\n",i);
    i = my_strrindex("dsaa", 'a');
    printf("%i\n",i);
    i = my_strrindex("afadsajbfd9", 'a');
    printf("%i\n",i);
